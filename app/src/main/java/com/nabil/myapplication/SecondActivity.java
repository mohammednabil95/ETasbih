...
public class SecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        demoList.add(new Demo("سُبْحاَنَ اللهِ","Glory be to Allah"));
        demoList.add(new Demo("اَلْحَمْدُ لِلهِ","Praise be to Allah"));
        demoList.add(new Demo("اَلّلَهُ اَكْبَرْ","Allah is the Greatest"));
        demoList.add(new Demo("لا إله إلا اللهْ","There is no God but Allah"));
